...
| GBxxx | **Ada** | RTX50xx, RTXPro-x000 | - | - | supported | supported | 
...
| ---:|:------ | ------ | ------ | -- | -- | ---- | --------------------------------- |
| **R390** | ~~2022 Dec~~ **[LTS]** | **9.1** | **7** | **Yes** | only thru **RHEL7**, final DC-LTS for **Fermi**, supports thru Pascal |
| R396 | ~~2019 Mar~~ | 9.2 | 7 8 | - | final 32-bit x86, 300 series and Fermi driver support |
| **R470** | ~~2024 Sep~~ **[LTS]** | **11.4** | **7 8** | **Yes** | only thru **RHEL8**, last DC-LTS for **Kepler**, supports thru **Ampere** |
| R495 | ~~2023 Jun~~ | 11.5 | **7 8** | - | final 400 series and Kepler driver support |
| **R535** | 2026 Jun **[LTS]** | **12.2** | **7 8 9** | **Yes** | min **Maxwell**, min **Turing** for `open` driver |
| R550 | ~~2025 Apr~~ | 12.4 | 7 8 9 | Yes | final **RHEL7** driver, first `open` driver to be fully functional |
| **R580** | **2028 Jun** **[LTS]** | **13.0** | **8 9 10** | **Yes** | first **RHEL10** driver, final DC-LTS for **Maxwell/Pascal**
| R595 | 2027 Mar | 13.2 | 8 9 10 | Yes | final 500 driver, last | final 500 series and Maxwell/Pascall driver support
| R610 | 2027 Jun | 13.3 | 8 9 10 | - | min **Turing**, solely `open` driver
...
The following Table breaks down the RHEL releases and their GPU Support.

| **Attribute** | **RHEL7** | **RHEL8** | **RHEL9** | **RHEL10** |
| ----------------:| ------------------------ | ------------------------ | ------------------------ | ------------------------ | 
...
| **Legacy 300 series Driver** | R390 DC-LTS, R346-396 | - | - | 
| **Legacy 400 series Driver** | R470 DC-TLS, R410-495 (all) | R470 DC-LTS, R410-495 (all) | - | - |
| **Legacy 500 series Driver** | R535 DC-LTS, R510-550 | R580 DC-LTS, R515-595 | Legacy R580 R580-595 (Wayland-only)
...
Here is the page from R610 (610.43.02), and the direct anchor links to the Legacy R580, R470 and R390 Data Center certified and Long Term Support (DC-LTS) support lists.
 ...
 * Legacy R390 DC-LTS:  ttps://us.download.nvidia.com/XFree86/Linux-x86_64/610.43.02/README/supportedchips.html#legacy_390.xx
